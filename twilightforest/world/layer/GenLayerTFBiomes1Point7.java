...
public class GenLayerTFBiomes1Point7 extends GenLayer {
    ...
    public GenLayerTFBiomes1Point7(long l, GenLayer genlayer) {
        super(l);
        this.commonBiomes = new BiomeGenBase[] { TFBiomeBase.twilightForest, TFBiomeBase.twilightForest2, TFBiomeBase.mushrooms, TFBiomeBase.oakSavanna, TFBiomeBase.fireflyForest};
        this.rareBiomes = new BiomeGenBase[] { TFBiomeBase.tfLake, TFBiomeBase.deepMushrooms, TFBiomeBase.enchantedForest, TFBiomeBase.clearing};
