...
public class EntityTFIceSnowball extends EntityThrowable {
    ...
    public void makeTrail() {
        for (int i = 0; i < 2; ++i) {
            ...
            this.field_70170_p.func_72869_a("snowballpoof", dx, dy, dz, 0.0D, 0.0D, 0.0D);
        }
    ...
    protected void pop() {
        for (int i = 0; i < 8; ++i) {
            this.field_70170_p.func_72869_a("snowballpoof", this.field_70165_t, this.field_70163_u, this.field_70161_v, this.field_70146_Z.nextGaussian() * 0.05D, this.field_70146_Z.nextDouble() * 0.2D, this.field_70146_Z.nextGaussian() * 0.05D);
        }
